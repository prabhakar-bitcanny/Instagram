...
ActiveRecord::Schema.define(version: 2021_10_06_123100) do
  ...
  create_table "blocks", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["blocked_by_id", "blocked_id"], name: "index_blocks_on_blocked_by_id_and_blocked_id", unique: true
  ...
  create_table "msgs", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["chat_id"], name: "index_msgs_on_chat_id"
